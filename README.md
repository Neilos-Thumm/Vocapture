...
There is also a plug-and-play alternative [Definition Harvester](https://github.com/Neilos-Thumm/DefinitionHarvester) that utilizes AI overview and implemented as chrome extension
